...
def main():
    ...
    if args.model == "BOW":
        ...
        train_data = SentimentDatasetDAN("data/train.txt", 'glove')
        dev_data = SentimentDatasetDAN("data/dev.txt", 'glove')
    ...
    if args.model == "BOW":
        ...
        start_time = time.time()
        print('\n2 layers:')
        nn2_train_accuracy, nn2_test_accuracy = experiment(NN2DAN(input_size=300, hidden_size=100), train_loader, test_loader)

        # Train and evaluate NN3
        print('\n3 layers:')
        nn3_train_accuracy, nn3_test_accuracy = experiment(NN3DAN(input_size=300, hidden_size=100), train_loader, test_loader)
